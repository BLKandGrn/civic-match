    ...
    <div style={{ minHeight:"100vh", background:"#0e0e0e", color:"#f0f0f0", fontFamily:FF_NEWS, display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ flex:1, display:"flex", justifyContent:"center", padding:"40px 20px 80px" }}>
        <div className={anim ? "sIn" : "sOut"} style={{ width:"100%", maxWidth:"680px" }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:"24px" }}>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:"10px" }}>
                {ISSUES.map(function(issue) {
                  ...
                  return (
                    <div key={issue.id} style={{ display:"flex", alignItems:"center", justifyContent:"space-between", gap:"16px", background:"#141414", border:"1px solid " + (val !== undefined ? PC[val] : "#2a2a2a"), borderRadius:"6px", padding:"14px 16px", flexWrap:"wrap" }}>
                      <div style={{ flex:1, minWidth:"160px" }}>
                        <div style={{ fontFamily:FF_SYNE, fontWeight:600, fontSize:"14px", color:"#eee", marginBottom:"2px" }}>{issue.label}</div>
                        <div style={{ fontSize:"12px", color:"#666", lineHeight:1.4 }}>{issue.desc}</div>
                      </div>
                      <div style={{ display:"flex", gap:"6px", flexShrink:0 }}>
                        {[3,2,1,0].map(function(lv) {
                          return (
          ...
          {cur === "address" && (
            <div style={{ display:"flex", flexDirection:"column", gap:"24px" }}>
              <div style={{ fontFamily:FF_SYNE, fontSize:"11px", fontWeight:600, letterSpacing:".18em", color:"#C8F97A", textTransform:"uppercase" }}>Step 2 of 3</div>
          ...
          {cur === "registration" && (
            <div style={{ display:"flex", flexDirection:"column", gap:"24px" }}>
              <div style={{ fontFamily:FF_SYNE, fontSize:"11px", fontWeight:600, letterSpacing:".18em", color:"#C8F97A", textTransform:"uppercase" }}>Step 3 of 3</div>
          ...
          {cur === "results" && results && (
            <div style={{ display:"flex", flexDirection:"column", gap:"24px" }}>
              ...
              <div style={{ background:"#141414", border:"1px solid #2a2a2a", borderRadius:"6px", padding:"16px 20px" }}>
                <div style={{ fontFamily:FF_SYNE, fontSize:"11px", fontWeight:600, letterSpacing:".15em", color:"#666", textTransform:"uppercase", marginBottom:"10px" }}>Your Top Priorities</div>
                <div style={{ display:"flex", gap:"8px", flexWrap:"wrap" }}>
                  {ISSUES.map(function(i) { return { id:i.id, label:i.label, score: priorities[i.id]||0 }; }).sort(function(a,b) { return b.score-a.score; }).filter(function(i) { return i.score > 0; }).slice(0,5).map(function(i) {
                    return <div key={i.id} style={{ fontFamily:FF_SYNE, fontWeight:700, fontSize:"11px", letterSpacing:".06em", padding:"5px 12px", borderRadius:"20px", background:PC[i.score], color:"#0e0e0e" }}>{i.label}</div>;
                  })}
                </div>
              </div>
